...
// [EmployeeAccessConfigBuilder] setting db access: true
// [EmployeeAccessConfigBuilder] setting server access: true
// [EmployeeAccessConfigBuilder] setting email access: true
// [EmployeeAccessConfigBuilder] setting aws access: true
// [EmployeeAccessConfigBuilder] setting vpn access: true
// [EmployeeAccessConfigBuilder] setting slack access: true
// id = 1
// dbAcess = true
// serverAccess = true
// emailAccess = true
...
// [EmployeeAccessConfigBuilder] setting db access: false
// [EmployeeAccessConfigBuilder] setting server access: false
// [EmployeeAccessConfigBuilder] setting email access: false
// [EmployeeAccessConfigBuilder] setting aws access: false
// [EmployeeAccessConfigBuilder] setting vpn access: false
// [EmployeeAccessConfigBuilder] setting slack access: false
// id = 2
// dbAcess = false
// serverAccess = false
// emailAccess = false
